...
class Entry:
    ...
    def __init__(self, disk: Disk, name: bytes = b"", sector: int = 1, size: int = 0, parent_dir=None,
    ...
    def __check_name(name: bytes):
        ...
        allowed = b"ABCDEGHIJKLMNOPQRSTUVWXYZ0123456789.-\0"
...
class Directory:
    ...
    def __init__(self, entry: Entry, parse: bool = True):
        ...
        if not parse:
            ...
            if self.entry.disk.bin_file.read(1)[0] != b'>'[0] or self.entry.size != 0:
